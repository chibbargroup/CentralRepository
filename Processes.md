...
11. Use Samtools and bcftools to create a combined pileup of all samples
  ...
  - piped into bcftools to only keep relevant variants
	- `samtools mpileup -f ./ref.fa -b ./bam_list.txt | bcftools call -vcO z -o all.raw.vcf.gz`
